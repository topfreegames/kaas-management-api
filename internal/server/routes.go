...
func (r RouterConfig) setupClusterV1Routes() {
	...
	clusterv1.Endpoint.CreateRoute("GET", "/:"+clusterv1.ClusterNameParameter+"/nodegroups", r.controller.NodeGroupListByClusterHandler)
	clusterv1.Endpoint.CreateRoute("GET", "/:"+clusterv1.ClusterNameParameter+"/nodegroups"+"/:"+nodegroupv1.NodeGroupNameParameter, r.controller.NodeGroupByClusterHandler)
